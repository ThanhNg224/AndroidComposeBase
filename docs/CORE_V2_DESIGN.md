...
`com.thanhng224.androidcomposebase.core.foundation`. A build-logic verification task fails when that
...
`com.thanhng224.androidcomposebase.core.ui.text.UiText` is explicitly Android presentation code: it
