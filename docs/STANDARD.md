...
| Style/theme/text appearance | Android style hierarchy with the base prefix | `Theme.AndroidComposeBase`, `Widget.AndroidComposeBase.Toolbar`, `TextAppearance.AndroidComposeBase.Body` |
