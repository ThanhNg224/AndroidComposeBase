...
| Rules | 56,130 total — 354 from `com.thanhng224` (`:core`), 706 from `com.thanhng224.androidcomposebase` (`:app`) |
...
baselineprofile/build/outputs/connected_android_test_additional_output/benchmarkRelease/connected/SM-F936N - 16/
  com.thanhng224.androidcomposebase.baselineprofile-benchmarkData.json
...
D ProcessStarter: proc frequent died! proc = com.thanhng224.androidcomposebase callerPkg = null
```
